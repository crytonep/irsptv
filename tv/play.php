        ...
        <div class="col-12">
            ...
            <div class="hidden embed-responsive embed-responsive-16by9" id="playerContainer" style="width: 100%; margin: auto; box-shadow: 2px 2px 8px 2px #2c2c2c;">
                ...
                <?php }
                    ...
                    <iframe class="embed-responsive-item" width="100%" height="100%" src="star.php?c=<?=$result['channelId']?>" frameborder="0" scrolling="no" allowfullscreen allow-encrypted-media></iframe>
                <?php } ?>
            </div>
        </div>
