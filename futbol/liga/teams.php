...
// Equipos
    ...
    $local = str_replace('fc andorra', 'FC Andorra', $local);
    ...
    $local = str_replace('sportinggijn', 'Real Sporting', $local);
    ...
    $local = str_replace('ud ibiza', 'UD Ibiza', $local);
    ...
    $visita = str_replace('fc andorra', 'FC Andorra', $visita);
    ...
    $visita = str_replace('sportinggijn', 'Real Sporting', $visita);
    ...
    $visita = str_replace('ud ibiza', 'UD Ibiza', $visita);
    $visita = str_replace('ibiza', 'UD Ibiza', $visita);
    $visita = str_replace('laspalmas', 'UD Las Palmas', $visita);
    // Copa del Rey
    $local = str_replace("barbads", "Barbadás", $local);
    $local = str_replace("cdmanacor", "CD Manacor", $local);
    $local = str_replace("cdfuentes", "CD Fuentes", $local);
    $local = str_replace("ueolot", "UE Olot", $local);
    $local = str_replace("udlogros", "UD Logroñés", $local);
    $local = str_replace("ud logros", "UD Logroñés", $local);
    $local = str_replace("at.saguntino", "Atlético Saguntino", $local);
    $local = str_replace("sestaoriver", "Sestao River", $local);
    $local = str_replace("arenasclub", "Arenas Club", $local);
    $local = str_replace("cdutrera", "CD Utrera", $local);
    $local = str_replace("adceuta", "AD Ceuta", $local);
    $local = str_replace("ad ceuta", "AD Ceuta", $local);
    $local = str_replace("hutortjar", "Huétor Tájar", $local);
    $local = str_replace("racingrioja", "Racing Rioja", $local);
    $local = str_replace("nstictarragona", "Nástic Tarragona", $local);
    $local = str_replace("nstic tarragona", "Nástic Tarragona", $local);
    $local = str_replace("cdl'alcora", "CD L'Alcora", $local);
    $local = str_replace("cdautol", "CD Autol", $local);
    $local = str_replace("carereo", "Cacereño", $local);
    $local = str_replace("crdoba", "Córdoba", $local);
    $local = str_replace("cristoatltico", "Cristo Atlético", $local);
    $local = str_replace("cdcoria", "CD Coria", $local);
    $local = str_replace("cdrincn", "CD Rincón", $local);
    $local = str_replace("cdsantaamalia", "CD Santa Amalia", $local);
    $local = str_replace("sdalmazn", "SD Almazán", $local);
    $local = str_replace("recreativohuelva", "Recreativo Huelva", $local);
    $local = str_replace("hrcules", "Hércules", $local);
    $local = str_replace("lanuca", "La Nucía", $local);
    $local = str_replace("gimnsticatorrelavega", "Gimnástica Torrelavega", $local);
    $local = str_replace("peadeportiva", "Peña Deportiva", $local);
    $local = str_replace("uninadarve", "Unión Adarve", $local);
    $local = str_replace("linaresdeportivo", "Linares Deportivo", $local);
    $local = str_replace("cddiosesano", "CD Diosesano", $local);
    $local = str_replace("lasrozas", "Las Rozas", $local);
    $local = str_replace("cemanresa", "CE Manresa", $local);
    $local = str_replace("cdibizaislaspitiusas", "CD Ibiza", $local);
    $local = str_replace("rayomajadahonda", "Rayo Majadahonda", $local);
    $local = str_replace("cdquintardelrey", "CD Quintar del Rey", $local);
    $local = str_replace("cfvimenor", "CF Vimenor", $local);
    $local = str_replace("cdatlticopaso", "CD Atlético Paso", $local);
    $local = str_replace("at.baleares", "Atlético Baleares", $local);
    $local = str_replace("cdalfaro", "CD Alfaro", $local);
    $local = str_replace("juventudtorremoinoscf", "Juventud Torremolinos", $local);
    $local = str_replace("cdalgar", "CD Algar", $local);
    $local = str_replace("velardecf", "Velarde CF", $local);
    $local = str_replace("ourensecf", "Ourense CF", $local);
    $local = str_replace("adsanjuan", "AD San Juan", $local);
    $local = str_replace("admrida", "AD Mérida", $local);
    $local = str_replace("realunin", "Real Unión", $local);
    $local = str_replace("sanroquelepe", "San Roque Lepe", $local);
    ...
    $visita = str_replace("cdfuentes", "CD Fuentes", $visita);
    $visita = str_replace("ueolot", "UE Olot", $visita);
    $visita = str_replace("udlogros", "UD Logroñés", $visita);
    $visita = str_replace("ud logros", "UD Logroñés", $visita);
    $visita = str_replace("at.saguntino", "Atlético Saguntino", $visita);
    $visita = str_replace("sestaoriver", "Sestao River", $visita);
    $visita = str_replace("arenasclub", "Arenas Club", $visita);
    $visita = str_replace("cdutrera", "CD Utrera", $visita);
    $visita = str_replace("adceuta", "AD Ceuta", $visita);
    $visita = str_replace("ad ceuta", "AD Ceuta", $visita);
    $visita = str_replace("hutortjar", "Huétor Tájar", $visita);
    $visita = str_replace("racingrioja", "Racing Rioja", $visita);
    $visita = str_replace("nstictarragona", "Nástic Tarragona", $visita);
    $visita = str_replace("nstic tarragona", "Nástic Tarragona", $visita);
    $visita = str_replace("cdl'alcora", "CD L'Alcora", $visita);
    $visita = str_replace("cdautol", "CD Autol", $visita);
    $visita = str_replace("carereo", "Cacereño", $visita);
    $visita = str_replace("crdoba", "Córdoba", $visita);
    $visita = str_replace("cristoatltico", "Cristo Atlético", $visita);
    $visita = str_replace("cdcoria", "CD Coria", $visita);
    $visita = str_replace("cdrincn", "CD Rincón", $visita);
    $visita = str_replace("cdsantaamalia", "CD Santa Amalia", $visita);
    $visita = str_replace("sdalmazn", "SD Almazán", $visita);
    $visita = str_replace("recreativohuelva", "Recreativo Huelva", $visita);
    $visita = str_replace("hrcules", "Hércules", $visita);
    $visita = str_replace("lanuca", "La Nucía", $visita);
    $visita = str_replace("gimnsticatorrelavega", "Gimnástica Torrelavega", $visita);
    $visita = str_replace("peadeportiva", "Peña Deportiva", $visita);
    $visita = str_replace("uninadarve", "Unión Adarve", $visita);
    $visita = str_replace("linaresdeportivo", "Linares Deportivo", $visita);
    $visita = str_replace("cddiosesano", "CD Diosesano", $visita);
    $visita = str_replace("lasrozas", "Las Rozas", $visita);
    $visita = str_replace("cemanresa", "CE Manresa", $visita);
    $visita = str_replace("cdibizaislaspitiusas", "CD Ibiza", $visita);
    $visita = str_replace("rayomajadahonda", "Rayo Majadahonda", $visita);
    $visita = str_replace("cdquintardelrey", "CD Quintar del Rey", $visita);
    $visita = str_replace("cfvimenor", "CF Vimenor", $visita);
    $visita = str_replace("cdatlticopaso", "CD Atlético Paso", $visita);
    $visita = str_replace("at.baleares", "Atlético Baleares", $visita);
    $visita = str_replace("cdalfaro", "CD Alfaro", $visita);
    $visita = str_replace("juventudtorremoinoscf", "Juventud Torremolinos", $visita);
    $visita = str_replace("cdalgar", "CD Algar", $visita);
    $visita = str_replace("velardecf", "Velarde CF", $visita);
    $visita = str_replace("ourensecf", "Ourense CF", $visita);
    $visita = str_replace("adsanjuan", "AD San Juan", $visita);
    $visita = str_replace("admrida", "AD Mérida", $visita);
    $visita = str_replace("realunin", "Real Unión", $visita);
    $visita = str_replace("sanroquelepe", "San Roque Lepe", $visita);
