...
if ($canal === "Gol Mundial" || $canal === "Gol Mundial" || $canal === "Gol Mundial" || $canal === "golm") {
    ...
    <div>
        <a
        href="' . $app . '/agenda/play?futbol&id=' . $index . '&c=golmsd"
        class="btn btn-lg btn-primary">
            Gol Mundial | VIP HD
        </a>
    </div>
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?futbol&id=' . $index . '&c=golmsd">
        <i class="flag es"></i>
        Gol Mundial | VIP SD
        </a>
    </div>';
    ...
    $canalop4 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?futbol&id=' . $index . '&c=golm">
        <i class="flag es"></i>
        Gol Mundial | VIP HD
        </a>
    </div>
...
if ($canal === "M+ Liga de Campeones" || $canal === "M+ Liga de Campeones UHD (M441 O115)" || $canal === "M+ Liga de Campeones (M56 O114)" || $canal === "mlcamp") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?futbol&id=' . $index . '&c=mlcamp">
        <i class="flag es"></i>
        Movistar Liga de Campeones | VIP HD
        </a>
    </div>
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?futbol&id=' . $index . '&c=mlcampsd">
        <i class="flag es"></i>
...
if ($canal === "M+ Liga de Campeones 2" || $canal === "mlcamp2") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?c=mlcamp2">
        <i class="flag es"></i>
...
if ($canal === "M+ Liga de Campeones 3" || $canal === "mlcamp3") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?c=mlcamp3">
        <i class="flag es"></i>
...
if ($canal === "M+ Liga de Campeones 4" || $canal === "mlcamp4") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?c=mlcamp4">
        <i class="flag es"></i>
...
if ($canal === "M+ Liga de Campeones 5" || $canal === "mlcamp5") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?c=mlcamp5">
        <i class="flag es"></i>
...
if ($canal === "M+ LaLiga" || $canal === "M+ LaLigaTV" || $canal === "bar") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?futbol&id=' . $index . '&c=bar">
        <i class="flag es"></i>
        Movistar LaLiga | VIP HD
        </a>
    </div>
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?futbol&id=' . $index . '&c=barsd">
        <i class="flag es"></i>
...
if ($canal === "M+ LaLiga 1" || $canal === "mlaliga1") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?futbol&id=' . $index . '&c=mlaliga1">
        <i class="flag es"></i>
...
if ($canal === "M+ LaLiga 2" || $canal === "mlaliga2") {
    ...
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?futbol&id=' . $index . '&c=mlaliga2">
        <i class="flag es"></i>
...
if ($canal === "M+ LaLiga 3" || $canal === "mlaliga3") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?futbol&id=' . $index . '&c=mlaliga3">
        <i class="flag es"></i>
...
if ($canal === "M+ LaLiga 7" || $canal === "mlaliga7") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?futbol&id=' . $index . '&c=mlaliga7">
        <i class="flag es"></i>
...
if ($canal === "M+ Deportes" || $canal === "mdep") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?futbol&id=' . $index . '&c=mdep">
        <i class="flag es"></i>
...
if ($canal === "M+ #Vamos" || $canal === "M+ #Vamos Bar 2 (305)" || $canal === "mvamos") {
    ...
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?futbol&id=' . $index . '&c=mvamos">
        <i class="flag es"></i>
...
if ($canal === "GOL" || $canal === "GOL (Síguelo en directo)" || $canal === "goles") {
    ...
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?futbol&id=' . $index . '&c=goles">
        <i class="flag es"></i>
        GOL | VIP HD
        </a>
    </div>';
...
if ($canal === "DAZN" || $canal === "DAZN" || $canal === "dazn1" || $canal === "DAZN 1 (Movistar 64)") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play/?futbol&id=' . $index . '&c=dazn1">
        <i class="flag es"></i>
        DAZN 1 | HD
        </a>
    </div>
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg?futbol&id=' . $index . '&c=560">
        <i class="flag es"></i>
        DAZN 1 | VIP HD
        </a>
    </div>';
    ...
    $canalop4 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play/?c=dazn1">
        <i class="flag es"></i>
        DAZN 1 | HD
        </a>
    </div>
...
if ($canal === "DAZN2" || $canal === "DAZN 2 (Movistar 65)" || $canal === "dazn2") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg?futbol&id=' . $index . '&c=569">
        <i class="flag es"></i>
        DAZN 2 | HD
        </a>
    </div>
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?futbol&id=' . $index . '&c=dazn2">
        <i class="flag es"></i>
        DAZN 2 | VIP HD
        </a>
    </div>';
...
if ($canal === "DAZN3" || $canal === "DAZN3" || $canal === "dazn3") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?futbol&id=' . $index . '&c=dazn3">
        <i class="flag es"></i>
        DAZN 3 | VIP HD
        </a>
    </div>';
...
if ($canal === "DAZN LaLiga" || $canal === "DAZN LaLiga" || $canal === "daznlaliga") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg/?futbol&id=' . $index . '&c=559">
        <i class="flag es"></i>
        DAZN LaLiga | HD
        </a>
    </div>
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?futbol&id=' . $index . '&c=daznlaliga">
        <i class="flag es"></i>
        DAZN LaLiga | VIP HD
        </a>
    </div>';
    ...
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?futbol&id=' . $index . '&c=daznlaliga2">
        <i class="flag es"></i>
        DAZN LaLiga | VIP HD
        </a>
    </div>';
...
if ($canal === "DAZN LaLiga 2" || $canal === "DAZN LaLiga 2" || $canal === "daznlaliga2") {
    ...
    $canalop4 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg/?futbol&id=' . $index . '&c=daznlaliga2">
        <i class="flag es"></i>
        DAZN LaLiga 2 | HD
        </a>
    </div>';
...
if ($canal === "LaLiga SmartbankTV" || $canal === "LaLiga SmartbankTV" || $canal === "smartbank") {
    ...
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?futbol&id=' . $index . '&c=smartbank">
        <i class="flag es"></i>
...
if ($canal === "LaLiga SmartbankTV 1" || $canal === "LaLiga SmartbankTV 1" || $canal === "smartbank1") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?futbol&id=' . $index . '&c=smartbank1">
        <i class="flag es"></i>
...
if ($canal === "directv1" || $canal === "directv1") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg?futbol&id=' . $index . '&c=561">
        <i class="flag ar"></i>
        DirecTV Sports | HD
        </a>
    </div>';
...
if ($canal === "directv2" || $canal === "directv2") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg?futbol&id=' . $index . '&c=562">
        <i class="flag ar"></i>
        DirecTV Sports 2 | HD
        </a>
    </div>';
...
if ($canal === "La 1 TVE" || $canal === "La 1 TVE") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg?futbol&id=' . $index . '&c=93">
        <i class="flag es"></i>
        La 1 | HD
        </a>
    </div>';
    ...
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg?futbol&id=' . $index . '&c=310">
        <i class="flag es"></i>
        La 1 [OP2] | HD
        </a>
    </div>';
...
if ($canal === "espnsur" || $canal === "espnsur") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg?futbol&id=' . $index . '&c=1">
        <i class="flag ar"></i>
        ESPN Sur | HD
        </a>
    </div>';
...
if ($canal === "espn2sur" || $canal === "espn2sur") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg?futbol&id=' . $index . '&c=2">
        <i class="flag ar"></i>
        ESPN 2 Sur | HD
        </a>
    </div>';
...
if ($canal === "espn3sur" || $canal === "espn3sur") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg?futbol&id=' . $index . '&c=3">
        <i class="flag ar"></i>
        ESPN 3 Sur | HD
        </a>
    </div>';
...
if ($canal === "espnextra" || $canal === "espnextra") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg?futbol&id=' . $index . '&c=4">
        <i class="flag ar"></i>
        ESPN Extra | HD
        </a>
    </div>';
...
if ($canal === "espnmx" || $canal === "espnmx") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg/?futbol&id=' . $index . '&c=564">
        <i class="flag mx"></i>
        ESPN | HD
        </a>
    </div>';
...
if ($canal === "espn2mx" || $canal === "espn2mx") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg/?futbol&id=' . $index . '&c=583">
        <i class="flag mx"></i>
        ESPN 2 | HD
        </a>
    </div>';
...
if ($canal === "espndep" || $canal === "espndep") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg/?futbol&id=' . $index . '&c=609">
        <i class="flag mx"></i>
        ESPN Deportes | HD
        </a>
    </div>';
...
if ($canal === "foxsportssur" || $canal === "foxsportssur") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg?futbol&id=' . $index . '&c=5">
        <i class="flag ar"></i>
        FOX Sports | HD
        </a>
    </div>';
...
if ($canal === "foxsports2sur" || $canal === "foxsports2sur") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg?futbol&id=' . $index . '&c=6">
        <i class="flag ar"></i>
        FOX Sports 2 | HD
        </a>
    </div>';
...
if ($canal === "foxsports3sur" || $canal === "foxsports3sur") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg?futbol&id=' . $index . '&c=7">
        <i class="flag ar"></i>
        FOX Sports 3 | HD
        </a>
    </div>';
...
if ($canal === "foxsportsmx" || $canal === "foxsportsmx") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg/?futbol&id=' . $index . '&c=565">
        <i class="flag mx"></i>
        Fox Sports | HD
        </a>
    </div>';
...
if ($canal === "foxsport3smx" || $canal === "foxsports3mx") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg/?futbol&id=' . $index . '&c=566">
        <i class="flag mx"></i>
        Fox Sports 3 | HD
        </a>
    </div>';
...
if ($canal === "tyc" || $canal === "tyc") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg?futbol&id=' . $index . '&c=257">
        <i class="flag ar"></i>
        TyC Sports | HD
        </a>
    </div>';
...
if ($canal === "winplus" || $canal === "winplus") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg?futbol&id=' . $index . '&c=279">
        <i class="flag co"></i>
        Win Sports + | HD
        </a>
    </div>';
...
if ($canal === "Esport3" || $canal === "Esport3 (Cataluña)") {
    ...
    $canalop4 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg?futbol&id=' . $index . '&c=253">
        <i class="flag es"></i>
        Esport3 | HD
        </a>
    </div>';
...
if ($canal === "Aragón Deporte" || $canal === "AragÃ³n Deporte") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg?futbol&id=' . $index . '&c=118">
        <i class="flag es"></i>
        Aragón Deporte | HD
        </a>
    </div>';
    ...
    $canalop4 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg?futbol&id=' . $index . '&c=119">
        <i class="flag es"></i>
...
if ($canal === "ZDF (M+ Astra)" || $canal === "ZDF (M+ Astra)") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/tv/epg?futbol&id=' . $index . '&c=232">
        <i class="flag de"></i>
        ZDF | HD
        </a>
    </div>';
...
if ($canal === "tudnusa" || $canal === "tudnusa") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . '/agenda/play?futbol&id=' . $index . '&c=tudnusa">
        <i class="flag mx"></i>
        TUDN | VIP HD
        </a>
    </div>';
