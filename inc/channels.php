...
if ($canal === "DAZN2" || $canal === "DAZN 2 (Movistar 65)" || $canal === "dazn2") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . 'tv/?futbol&id=' . $index . '&c=569">
        <i class="flag es"></i>
        DAZN 2 | HD
        </a>
    </div>
...
if ($canal === "directv1" || $canal === "directv1") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . 'tv/?futbol&id=' . $index . '&c=561">
        <i class="flag ar"></i>
        DirecTV Sports | HD
        </a>
    </div>';
...
if ($canal === "directv2" || $canal === "directv2") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . 'tv/?futbol&id=' . $index . '&c=562">
        <i class="flag ar"></i>
        DirecTV Sports 2 | HD
        </a>
    </div>';
...
if ($canal === "La 1 TVE" || $canal === "La 1 TVE") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . 'tv/?futbol&id=' . $index . '&c=93">
        <i class="flag es"></i>
        La 1 | HD
        </a>
    </div>';
    ...
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . 'tv/?futbol&id=' . $index . '&c=310">
        <i class="flag es"></i>
        La 1 [OP2] | HD
        </a>
    </div>';
...
if ($canal === "espnsur" || $canal === "espnsur") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . 'tv/?futbol&id=' . $index . '&c=1">
        <i class="flag ar"></i>
        ESPN Sur | HD
        </a>
    </div>';
...
if ($canal === "espn2sur" || $canal === "espn2sur") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . 'tv/?futbol&id=' . $index . '&c=2">
        <i class="flag ar"></i>
        ESPN 2 Sur | HD
        </a>
    </div>';
...
if ($canal === "espn3sur" || $canal === "espn3sur") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . 'tv/?futbol&id=' . $index . '&c=3">
        <i class="flag ar"></i>
        ESPN 3 Sur | HD
        </a>
    </div>';
...
if ($canal === "espnextra" || $canal === "espnextra") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . 'tv/?futbol&id=' . $index . '&c=4">
        <i class="flag ar"></i>
        ESPN Extra | HD
        </a>
    </div>';
...
if ($canal === "foxsportssur" || $canal === "foxsportssur") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . 'tv/?futbol&id=' . $index . '&c=5">
        <i class="flag ar"></i>
        FOX Sports | HD
        </a>
    </div>';
...
if ($canal === "foxsports2sur" || $canal === "foxsports2sur") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . 'tv/?futbol&id=' . $index . '&c=6">
        <i class="flag ar"></i>
        FOX Sports 2 | HD
        </a>
    </div>';
...
if ($canal === "foxsports3sur" || $canal === "foxsports3sur") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . 'tv/?futbol&id=' . $index . '&c=7">
        <i class="flag ar"></i>
        FOX Sports 3 | HD
        </a>
    </div>';
...
if ($canal === "tyc" || $canal === "tyc") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . 'tv/?futbol&id=' . $index . '&c=257">
        <i class="flag ar"></i>
        TyC Sports | HD
        </a>
    </div>';
...
if ($canal === "winplus" || $canal === "winplus") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . 'tv/?futbol&id=' . $index . '&c=279">
        <i class="flag co"></i>
        Win Sports + | HD
        </a>
    </div>';
...
if ($canal === "Esport3" || $canal === "Esport3 (Cataluña)") {
    ...
    $canalop4 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . 'tv/?futbol&id=' . $index . '&c=253">
        <i class="flag es"></i>
        Esport3 | HD
        </a>
    </div>';
...
if ($canal === "Aragón Deporte" || $canal === "AragÃ³n Deporte") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . 'tv/?futbol&id=' . $index . '&c=118">
        <i class="flag es"></i>
        Aragón Deporte | HD
        </a>
    </div>';
    ...
    $canalop4 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . 'tv/?futbol&id=' . $index . '&c=119">
        <i class="flag es"></i>
...
if ($canal === "ZDF (M+ Astra)" || $canal === "ZDF (M+ Astra)") {
    ...
    $canalop2 = '
    <div>
        <a class="btn btn-lg btn-primary" href="' . $app . 'tv/?futbol&id=' . $index . '&c=232">
        <i class="flag de"></i>
        ZDF | HD
        </a>
    </div>';
